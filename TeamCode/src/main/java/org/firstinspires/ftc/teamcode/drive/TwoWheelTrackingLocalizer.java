...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double WHEEL_RADIUS = 0.9468; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double PARALLEL_X = 7.8; // X is the up and down direction
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, BotBuildersMecanumDrive drive) {
        super(Arrays.asList(
