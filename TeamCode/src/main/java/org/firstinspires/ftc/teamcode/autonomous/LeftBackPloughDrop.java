...
@Autonomous(name="LeftBackPloughDrop", group="Auto")

public class LeftBackPloughDrop extends LinearOpMode
{
    OpenCvCamera camera;
    ...
    public void runOpMode()
    {
        ...
        TrajectorySequence tsPos1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .back(14) //four bar is coming down here - already
                .UNSTABLE_addTemporalMarkerOffset(1, () -> {
