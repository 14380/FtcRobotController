...
public class TurretRightUpFirstCloseAutoCommand extends SequentialCommandGroup {

    public TurretRightUpFirstCloseAutoCommand(
            ArmSubsystem arm,
            ...
            RobotStateSubsytem rState)
    {
        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        ...
                        new TurretAutoPosition(-785,turret)
