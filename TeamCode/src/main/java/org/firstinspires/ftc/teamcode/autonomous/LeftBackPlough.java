...
@Autonomous(name="LeftBackPlough", group="Auto")

public class LeftBackPlough extends LinearOpMode
{
    OpenCvCamera camera;
    ...
    public void runOpMode()
    {
        ...
        TrajectorySequence tsPos1 = drive.trajectorySequenceBuilder(startPose)
                ...
                .forward(54,
                        ...
                        BotBuildersMecanumDrive.getVelocityConstraint(47, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
